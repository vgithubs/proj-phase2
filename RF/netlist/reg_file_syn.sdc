...
# Created by write_sdc on Sun Oct 30 23:22:56 2022
...
{addr_r1[5]}] [get_ports {addr_r1[4]}] [get_ports {addr_r1[3]}] [get_ports     \
{addr_r1[2]}] [get_ports {addr_r1[1]}] [get_ports {addr_r1[0]}] [get_ports     \
{addr_r2[5]}] [get_ports {addr_r2[4]}] [get_ports {addr_r2[3]}] [get_ports     \
{addr_r2[2]}] [get_ports {addr_r2[1]}] [get_ports {addr_r2[0]}] [get_ports     \
{in_addr[5]}] [get_ports {in_addr[4]}] [get_ports {in_addr[3]}] [get_ports     \
{in_addr[2]}] [get_ports {in_addr[1]}] [get_ports {in_addr[0]}] [get_ports     \
